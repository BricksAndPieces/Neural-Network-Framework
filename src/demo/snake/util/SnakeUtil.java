...
public class SnakeUtil {
    ...
    // todo fix vision seeing final part of tail
    ...
    public static double[] getVision(Snake snake) {
        ...
        if(!snake.pointWithinWorld(p)) input[10] = 1;
        ...
        if(!snake.pointWithinWorld(p)) input[11] = 1;

        // BODY
        p = new Point(snake.getHeadLocation().x + snake.getDirection().getLeft().getX(),
                            snake.getHeadLocation().y + snake.getDirection().getLeft().getY());
        if(snake.getBodyLocations().contains(p) && !snake.getBodyLocations().get(snake.getBodyLocations().size()-1).equals(p)) input[7] = 1;

        p = new Point(snake.getHeadLocation().x + snake.getDirection().getX(),
                      snake.getHeadLocation().y + snake.getDirection().getY());
        if(snake.getBodyLocations().contains(p) && !snake.getBodyLocations().get(snake.getBodyLocations().size()-1).equals(p)) input[8] = 1;
